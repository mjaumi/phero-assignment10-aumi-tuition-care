...
const Blogs = () => {
    ...
    return (
        <section className='py-28'>
            <h2 className='text-tuition-care-base font-bold text-2xl md:text-4xl'>Questions & Answer</h2>
            <div className='w-[90%] md:w-4/5 mx-auto border-2 border-tuition-care-base p-5 rounded-2xl text-left text-tuition-care-base mt-8'>
